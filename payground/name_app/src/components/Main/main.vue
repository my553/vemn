<template>
  ...
  <div class="MainInfo">
    <div class="allStats">
      <div class="allNoRes">
        <b class="title">Общее количество неактивных ресурсов -
          <span class="count">{{ this.deactivateResource }}</span>
          <span class="time">Данные актуальны на {{ this.date }} 3:00</span>
        </b>
      </div>
      <div class="allRes">
        <b class="title">Общее количество ресурсов - <span class="count">{{ this.resources }}</span>
          <span class="time">Данные актуальны на {{ this.date }} 3:00</span>
        </b>
      </div>
      <div class="Owners">
        <b class="title">Клиентов -
          <span class="count">{{ this.owners }}</span>
          <span class="time">Данные актуальны на {{ this.date }} 3:00</span>
        </b>
      </div>
      <div class="WAF">
        <b class="title"> Ресурсов за WAF -
    ...
    <div class="weekStats">
      ...
      <div class="results">
        <div class="past">
          ...
          <span class="newNoRes">Новые неактивные ресурсы ({{ this.lastNoResCount }})</span>
          <span class="newWAF">Новые ресурсы за WAF ({{ this.lastNewWafCount }})</span>
          <div class="line1"></div>
          <div class="line2"></div>
          <div class="line3"></div>
        </div>
        <div class="current">
          ...
          <span class="newNoRes">Новые неактивные ресурсы ({{ this.currNoResCount }})</span>
          <span class="newWAF">Новые ресурсы за WAF ({{ this.currNewWafCount }})</span>
          <div class="line1"></div>
          <div class="line2"></div>
          <div class="line3"></div>
        </div>
    ...
    <div class="certs">
      <div class="title">
        <b class="text">Сертификаты, срок действия которых закончится в ближайшие 2 месяца <span
            class="count">({{ this.num }})</span></b>
      </div>
      <div class="results">
        <div class="head"><b class="resources">Ресурс</b><b class="date">Дата</b></div>
...
export default defineComponent({
  ...
  mounted() {
    ...
    const dataArray = [
      { resource: "zni.pag.ase.com", ip: "255.255.255.255", resolve: "активен", waf: "за WAF", ssl: "*.soc.mosreg.ru", date: "09.10.2023" },
      { resource: "zni.pag.ase.com", ip: "255.255.255.255", resolve: "активен", waf: "за WAF", ssl: "*.soc.mosreg.ru", date: "09.10.2023" },
      { resource: "zni.pag.ase.com", ip: "255.255.255.255", resolve: "активен", waf: "за WAF", ssl: "*.soc.mosreg.ru", date: "09.10.2023" },
    ];
